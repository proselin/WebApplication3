        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-4 p-0">
                    <div class="brand__item set-bg" data-setbg="img/brand/brand-1.png">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 p-0">
                    <div class="brand__item set-bg" data-setbg="img/brand/brand-2.png">
                        <div class="brand__text">
                            <i class="fa fa-brand"></i>
                            <a href="#">@ Victoria secrect</a>
                        </div>
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-sm-4 p-0">
                    <div class="brand__item set-bg" data-setbg="img/brand/brand-3.jpg">
                        <div class="brand__text">
                            <i class="fa fa-brand"></i>
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 p-0">
                    <div class="brand__item set-bg" data-setbg="img/brand/Next.png">
                        <div class="brand__text">
                            <i class="fa fa-brand"></i>
                            <a href="#">@ More</a>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row property__gallery">
                <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6><a href="product-details.html">NO5 chanel</a></h6>
                            <div class="rating">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/product/p5.jpg">
                            <ul class="product__hover">
                                <li><a href="img/product/p5.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="img/product/p6.jpg">
                            <div class="label sale">Sale</div>
                            <ul class="product__hover">
                                <li><a href="img/product/p6.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                        ...
                        <div class="product__item__text">
                            <h6><a href="#">Tropical chanel</a></h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/product/p7.jpg">
                            <div class="label new">New</div>
                            <ul class="product__hover">
                                <li><a href="img/product/p7.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            <h6><a href="product-details.html">Coco noir chanel</a></h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="img/product/p8.jpg">
                            <div class="label">Sale</div>
                            <ul class="product__hover">
                                <li><a href="img/product/p8.jpg" class="image-popup"><span
                                            class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            <h6><a href="#">Allure homme sport</a></h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
