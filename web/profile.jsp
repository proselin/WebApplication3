                    ...
                    <div class="card-body">
                        ...
                        <div class="about" style="margin-top: 20px;">
                            ...
                            <div class="progress">
                                ...
                                <p style="text-align: center"><strong>${levelprocess}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control disabled" id="website" value="<fmt:formatDate value="${user.getDate_of_birth()}"/>">
                            </div>
                        </div>
                    </div>
                    <div class="row gutters">
